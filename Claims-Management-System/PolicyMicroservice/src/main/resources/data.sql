...
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(1,101,201,5000.0,25,100000.00);
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(2,102,202,8000.0,21,120000.00);
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(3,103,203,15000.0,14,800000.00);
