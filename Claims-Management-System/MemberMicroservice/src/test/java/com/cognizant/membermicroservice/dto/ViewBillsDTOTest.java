...
/* 
 * This class contains test cases for the ViewBillsDTO class which are written
 * using junit
 */
...
public class ViewBillsDTOTest {
	...
	/*
	 * Test the ViewBillsDTO is not null
	 */

	@Test
	@DisplayName("Checking if ViewBillsDTO class is loading or not.")
	void viewBillsDTODTOIsLoadedOrNot() {
		assertThat(viewBillsDto).isNotNull();
	}

	/*
	 * Test the ViewBillsDTO constructor
	 */

	@DisplayName("Checking if ViewBillsDTO class is responding correctly or not.")
	@Test
