 ...
 * getmapping-getClaimStatus() postmapping-submitClaim()
 * 
 * @author Nikit Jain
 */
public class MemberPremiumController {
	...
	/*
	 * @param token- used to verify the token with jwtAuthentication microservice
	 * 
	 ...
	 * 
	 * @return ResponseEntity<Response> returns the details of the members having
	 * the particular memberId and policyId.
	 */
	 ...
	 * 
	 * @param benefitId - used to set the id of the benefit which comes under the
	 * particular policy
	 * 
