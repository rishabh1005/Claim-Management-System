...
public class ClaimsController {
	 ...
	 * first then invokes the claimServiceImpl which invokes the claimRepository and
	 ...
	 * 
	 * @return ResponseEntity of ClaimStatusDTO type Or
	 * 
	 * @return if token is invalid return responseEntityof type String(message) and
	 * status forbidden
	 */
	 ...
	 * @return ResponseEntity of type ClaimStatusDTO(claim status and its
	 * description) or if token is not valid
